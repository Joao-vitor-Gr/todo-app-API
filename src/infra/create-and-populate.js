...
const AD_USUARIOS_DATA = `
INSERT INTO USUARIOS (ID, NOME, EMAIL, SENHA)
VALUES 
    (1, 'João Vitor Gr', 'Jvitor@yahoo.com', '*******'),
    (2, 'ribeiro assis', 'assisribeiro@gmail.com', '********'),
    (3, 'resilia', 'resilia.org@yahoo.com', '********')
`
...
const AD_TAREFAS_DATA = `INSERT INTO TAREFAS (TITULO, DESCRICAO, STATUS, DATACRIACAO, ID_USUARIO)
VALUES 
